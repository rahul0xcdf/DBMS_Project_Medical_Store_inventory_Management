...
<div class="header">
<h1>Medical Store Inventory  Management System</h1>
 <p style="margin-top:-20px;line-height:1;font-size:30px;">A Database Management Systems Project</p>
 <p style="margin-top:-20px;line-height:1;font-size:20px;">Department of CSE-AIML </p>
</div>
<title>
Pharmacy
</title>
...
<body>
	...
	By 
	<br>
	Rahul R -PES1UG22AM128
	<br>
	Rahul Saravanan - PES1UG22AM129
	</div>
